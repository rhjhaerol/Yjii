<?php
    ...
    $regist_1 = isset($_COOKIE['regist_1']) ? (array) json_decode($_COOKIE['regist_1']) : [];
    $regist_2 = isset($_COOKIE['regist_2']) ? (array) json_decode($_COOKIE['regist_2']) : [];

    if (empty($regist_1) || empty($regist_2)) {
        header('Location: regist_1.php');
    } else if (!empty($regist_1) && empty($regist_2)) {
        header('Location: regist_2.php');
    }
    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"><a href="login.php">Starting Vacation</a></li>
                <li class="sidebar-nav-item"><a href="#page-top">Home</a></li>
                <li class="sidebar-nav-item"><a href="#about">About</a></li>
                <li class="sidebar-nav-item"><a href="#services">Services</a></li>
                <li class="sidebar-nav-item"><a href="#portfolio">Destination</a></li>
                <li class="sidebar-nav-item"><a href="#contact">Contact</a></li>
                <li class="sidebar-nav-item"><a href="task4.php">Cost Estimate</a></li>
                <li class="sidebar-nav-item"><a href="destination.php">Destination List</a></li>
                <li class="sidebar-nav-item"><a href="api/login.php?logout=1">Log Out</a></li>
            </ul>
        </nav>
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                <h1 class="mb-1" style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;">Yjii</h1>
